...
// 2. Write 2 variable and change value which can

// 3. Simple Math Operation( +, -, *, /, % )

// 4. comparison (six type)

// 5. Two conditions. "case-1: fulfil both conditions." "case-2: fulfill at least one condition"
